...
public class Common {
    ...
    public static final String SALOON_KEY = "SALOON";
    public static final String BARBER_KEY = "BARBER";
    public static final String TITLE_KEY = "title"; // this key need to be in small letter
    public static final String CONTENT_KEY = "content";
    public static final int MAX_NOTIFICATION_PER_LOAD = 10 ;
    public static final String SERVICES_ADDED = "SERVICES_ADDED";
    public static final double DEFAULT_PRICE = 30; //Default without extra services and item
    ...
    public static void updateToken(Context context, String token) {
        // First, we need to check if user is logged in or not.
        // This is because we need to store token belongs to the user
        ...
        if(user != null){
            if(!TextUtils.isEmpty(user)){
                ...
                myToken.setToken_type(TOKEN_TYPE.BARBER); // Because this code run from Barber staff app
