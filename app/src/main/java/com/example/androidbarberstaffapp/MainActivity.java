...
public class MainActivity extends AppCompatActivity implements IOnAllStateLoadListener {
    ...
    CollectionReference allSaloonCollection;
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        ...
                        else // If user already login
                        {
                            ...
                            Common.selectedSaloon = gson.fromJson(Paper.book().read(Common.SALOON_KEY,""),
                                    new TypeToken<Saloon>(){}.getType());
    ...
    private void init() {
        allSaloonCollection = FirebaseFirestore.getInstance().collection("AllSaloon");
