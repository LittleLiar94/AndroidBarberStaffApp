...
import com.example.androidbarberstaffapp.SaloonListActivity;
...
public class MyStateAdapter extends RecyclerView.Adapter<MyStateAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
        ...
        // Set Animation for RecyclerItem
        ...
        myViewHolder.setiRecyclerItemSelectedListener(new IRecyclerItemSelectedListener() {
            ...
            public void onItemSelectedListener(View view, int pos) {
                ...
                context.startActivity(new Intent(context, SaloonListActivity.class));
            }
        });
    }
